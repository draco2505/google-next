...
export const SearchBox = () => {
  ...
  const handleSubmit = (e) => {
    ...
    router.push(`/search/web?query=${term.trim()}`);
  };

  return (
    <form onSubmit={handleSubmit} className='flex border border-gray-200 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-grow mx-w-3xl items-center'>
      <input
        type="text"
